...
public class Teleop extends LinearOpMode {
    ...
    ElapsedTime RightBmp = new ElapsedTime();
    ElapsedTime LeftBmp = new ElapsedTime();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //double posankle = ankle.getPosition();
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.b){
                ...
                ankle.setPosition(pos+=velServo);
            }
            if (gamepad2.a){
                //ankle.setPosition(0 );
                ankle.setPosition(pos-=velServo);
